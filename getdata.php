...
function getdata($nilai1, $nilai2)
{
    ...
    $sql = "SELECT namaObat, hargaObat, gambarObat FROM obat WHERE idObat BETWEEN $nilai1 AND $nilai2";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<div class='items d-block position-relative col-2 d-flex flex-column bg-light m-2 py-2' style='border: 3px solid rgb(255, 255, 255); border-radius: 10px;'>
